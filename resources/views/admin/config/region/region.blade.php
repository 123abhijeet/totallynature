            ...
            <div class="card-body">
                <div style="float: right" class="card-title">
                    <button type="button" class="btn btn-success"
                        onclick="open_modal('{{ route('admin.config.region.create') }}','add_customer_loder','add_customer_btn','Add Region')"
                        >
                ...
                <table class="table" id="region_list">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
...
@section('javascript')
    <script>
        region_list = $('#region_list').DataTable({
            "aaSorting": [],
            "bDestroy": true,
            rowReorder: {
            ...
            ajax: {
                url: "{{ route('admin.config.region_list') }}",
                type: 'get',
            },
        })
    </script>
