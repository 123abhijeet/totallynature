...
<head>
  ...
  <link href="{{ asset('datatables/css/responsive.dataTables.min.css') }}" rel="stylesheet">
  <link href="{{ asset('datatables/css/rowReorder.dataTables.min.css') }}" rel="stylesheet">
