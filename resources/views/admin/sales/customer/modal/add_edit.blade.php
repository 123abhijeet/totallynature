...
<form class="row g-3" action="{{ $action }}" id="add_resion_form" method="{{ $method }}"
    ...
    @php
        ...
        $image = !empty($data->customer_image) ? asset($data->customer_image) :  'https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg';
    @endphp
    <div class="row mb-2">
        <div class="col-12">
        ...
        <input type="hidden" name="payment_type_id" value="{{ $data->payment_type_id ?? '' }}"> --}}
            ...
            <label for="inputNanme4" class="form-label">Customer Type</label>
            <select name="customer_type" id="customer_type" class="form-control">
                <option value="">Select</option>
                <option value="individual" {{ $customer_type == 'individual' ? 'selected' : ''}}>Individual</option>
                <option value="company" {{ $customer_type == 'company' ? 'selected' : ''}}>Company</option>
            </select>
    ...
    <div class="row" style="display: {{ $customer_type == 'individual' ? '' : 'none'}}" id="individual_section">
        ...
        <div class="col-md-6">
            <label for="inputNanme4" class="form-label">Customer Id *</label>
            <input type="text" class="form-control" name="individual_customer_id" value="{{ $data->customer_unique_id ?? '' }}">
        </div>
        <div class="col-md-6">
            <label for="inputNanme4" class="form-label">Customer Name *</label>
            <input type="text" class="form-control" name="individual_customer_name" value="{{ $data->customer_name ?? '' }}">
        </div>
    ...
    <div class="row" style="display: {{ $customer_type == 'company' ? '' : 'none'}}" id="company_section">
        ...
        <div class="col-md-6">
            <label for="inputNanme4" class="form-label">Customer Id*</label>
            <input type="text" class="form-control" name="company_customer_id" value="{{ $data->customer_unique_id ?? '' }}">
        </div>
        <div class="col-md-6">
